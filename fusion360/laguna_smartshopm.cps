/**
  ...
  Modified by Greg Kuchyt for Smart Shop M

  $Revision: 42858 7ffb30ac59c74f4de10060d458e61f87481d7b5d $
  $Date: 2020-07-20 05:18:37 $
  
  FORKID {09DC4A40-CFD9-4D89-91D5-70118B5F727E}
*/

description = "Laguna SmartShop M CNC Router";
vendor = "Laguna";
...
longDescription = "Post-processor for Generator's Laguna SmartShopM CNC router.";
...
function onOpen() {
  ...
  if (masterAxis >= 0) {
    ...
    var aAxis = createAxis({coordinate:masterAxis, table:true, axis:rotaryVector, cyclic:true, preference:0});
  ...
  writeBlock(gPlaneModal.format(17), gFormat.format(40), gFormat.format(49), gFormat.format(80), gAbsIncModal.format(90));

  //RichAuto controller is metric only
  unit = MM;
  writeComment("RichAuto controller is metric only.");
  switch (unit) {
  case IN:
